...
To get acces to the data by a variety of Web APIs which are described in Slate.
Please use the Slate documentation which is deployed on this git to get any further information to communicate with the Web API.
